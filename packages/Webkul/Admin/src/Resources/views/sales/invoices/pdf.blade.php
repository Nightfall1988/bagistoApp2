                ...
                <table class="sale-summary">
                    ...
                    @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                        <tr>
                            ...
                            <td>-</td>
                            <td>{!! core()->formatBasePrice($invoice->order->base_sub_total_incl_tax + $invoice->base_shipping_amount, true) !!}</td>
                        </tr>
                        <tr>
                            <td>@lang('admin::app.sales.invoices.invoice-pdf.subtotal-excl-tax')</td>
                            <td>-</td>
                            <td>{!! core()->formatBasePrice($invoice->order->sub_total + $invoice->base_shipping_amount, true) !!}</td>
                        </tr>
                    @else
                        <tr>
                            <td>@lang('admin::app.sales.invoices.invoice-pdf.subtotal')</td>
