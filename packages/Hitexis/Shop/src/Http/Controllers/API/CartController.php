...
use Hitexis\CartRule\Repositories\CartRuleCouponRepository;
...
use Hitexis\Shop\Http\Resources\CartResource;
...
class CartController extends APIController
{
    ...
    public function store()
    {
        ...
        $product = $this->productRepository->with('parent', 'wholesale')->findOrFail(request()->input('product_id'));
