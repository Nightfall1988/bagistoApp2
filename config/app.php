...
return [
    ...
    */
    ...
    'providers' => ServiceProvider::defaultProviders()->merge([
        ...
        Hitexis\Checkout\Providers\CheckoutServiceProvider::class,
        ...
        Hitexis\Marketing\Providers\MarketingServiceProvider::class,
        Webkul\Notification\Providers\NotificationServiceProvider::class,
        Webkul\Payment\Providers\PaymentServiceProvider::class,
        Webkul\Paypal\Providers\PaypalServiceProvider::class,
        Webkul\Product\Providers\ProductServiceProvider::class,
        Hitexis\Product\Providers\ProductServiceProvider::class,
        Webkul\Rule\Providers\RuleServiceProvider::class,
        Webkul\Sales\Providers\SalesServiceProvider::class,
        Webkul\Shipping\Providers\ShippingServiceProvider::class,
        Webkul\Shop\Providers\ShopServiceProvider::class,
        Hitexis\Shop\Providers\HitexisServiceProvider::class,
        Hitexis\Shop\Providers\ShopServiceProvider::class,
